...
async function runchashCode(req, res) {
  ...
  exec(
    `docker run --rm -v "${resolvedPath}:/usr/src/app" csharp-compiler`,
    (error, stdout, stderr) => {
